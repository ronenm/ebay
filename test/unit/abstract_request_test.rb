...
class EbayTest < Test::Unit::TestCase
  ...
  def test_set_detail_level_with_string
    desired = '<GeteBayOfficialTimeRequest><RequesterCredentials/><DetailLevel>ReturnAll</DetailLevel></GeteBayOfficialTimeRequest>'
  ...
  def test_set_detail_levels_with_string
    desired = '<GeteBayOfficialTimeRequest><RequesterCredentials/><DetailLevel>ReturnAll</DetailLevel><DetailLevel>None</DetailLevel></GeteBayOfficialTimeRequest>'
